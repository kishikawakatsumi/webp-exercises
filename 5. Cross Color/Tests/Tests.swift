...
func encode16x16() async throws {
  ...
  let expected = try Data(contentsOf: resources.appendingPathComponent("16x16CrossColor.webp"))
...
//  let data = try Data(
//    contentsOf: resources.appendingPathComponent("16x16CrossColor.webp")
//  )
//
