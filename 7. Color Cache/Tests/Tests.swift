...
func encode16x16() async throws {
  ...
  let expected = try Data(contentsOf: resources.appendingPathComponent("16x16ColorCache.webp"))
...
//  let data = try Data(
//    contentsOf: resources.appendingPathComponent("16x16ColorCache.webp")
//  )
//
